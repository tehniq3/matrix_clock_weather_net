 ...
 * ver.2ro4 - add arrow to wind dirrection
*/ 
...
/************************************(Wifi Einstellungen)**********************************/
const char* ssid     = "berica";     // SSID of local network
const char* password = "berelahalba";   // Password on network
/**************************(openweathermap.org Einstellungen)*******************************/
String weatherKey = "bererecedelabitoi1234567";
