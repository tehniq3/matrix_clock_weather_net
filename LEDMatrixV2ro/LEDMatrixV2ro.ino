 ...
 ** Autor: Alf Müller                                                                    **
 ** Datum: Mai 2018                                                                       **
 ** Version: 2.0  - https://youtu.be/BMY3TZdeMGw                                          ** 
...
/************************************(Wifi Einstellungen)**********************************/
const char* ssid     = "name_of_wifi_network";     // SSID of local network
const char* password = "password";   // Password on network

/**************************(openweathermap.org Einstellungen)*******************************/
String weatherKey = "ca55295cberece2688e0bere4b9a68de";  // APIkey from openweathermap.org site (need account)



String weatherLang = "&lang=en";
String cityID = "680332"; //Biberist
